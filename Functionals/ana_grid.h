...
!      f0=0.90E-04_r8
      ...
      Xsize=39.4_r8*REAL(Lm(ng),r8)
      Esize=39.4_r8*REAL(Mm(ng),r8)
      depth=depth_bcz(ng)
      f0=coriolis(ng)
      beta=0.0_r8
#elif defined PACIGW 
      Xsize=5000.0_r8*REAL(Lm(ng),r8)
      Esize=5000.0_r8*REAL(Mm(ng),r8)
      depth=4000.0_r8
!      f0=0.67305E-04_r8
      f0=0.62527E-04_r8
      beta=1.9824E-11_r8
...
!      f0=0.67305E-04_r8
      ...
      Xsize=800.0_r8*REAL(Lm(ng),r8)
      Esize=800.0_r8*REAL(Mm(ng),r8)
      depth=600.0_r8
!      f0=0.90E-04_r8
      f0=1.00E-04_r8
      beta=0.0_r8
#elif defined BIOCOLUMN 
      Xsize=1200.0_r8*REAL(Lm(ng),r8)
      Esize=1200.0_r8*REAL(Mm(ng),r8)
      depth=1000.0_r8
      f0=1.00E-04_r8
      beta=0.0_r8
